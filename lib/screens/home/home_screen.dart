...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        final chats = data
            ...
            .toList();
        setState(() { _chats = chats; _isLoading = false; _hasError = false; });
      } else {
  ...
  List<RecentChat> get _filteredChats {
    ...
    return _chats
        .where((c) => c.themUserName.toLowerCase().contains(_searchQuery.toLowerCase()))
        .toList();
  }
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: AppTheme.redAccent.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 3))],
                ),
                child: Center(
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton.icon(
              ...
              icon: const Icon(Icons.refresh_rounded, size: 16, color: AppTheme.redAccent),
              label: const Text('Retry', style: TextStyle(color: AppTheme.redAccent)),
            ),
          ],
        ),
      );
          ...
          children: [
            Icon(Icons.chat_bubble_outline_rounded, size: 56,
                color: isDark
                    ...
                    : AppTheme.lightTextSecondary.withOpacity(0.3)),
            const SizedBox(height: 16),
            Text(_searchQuery.isNotEmpty ? 'No chats found' : 'No chats yet',
                style: TextStyle(
                  color: isDark ? AppTheme.darkTextSecondary : AppTheme.lightTextSecondary,
            ...
            Text(
              _searchQuery.isNotEmpty ? 'Try a different search' : 'Tap + to start a new chat',
              style: TextStyle(
                color: isDark
                    ? AppTheme.darkTextSecondary.withOpacity(0.5)
                    : AppTheme.lightTextSecondary.withOpacity(0.5),
            ...
            await Navigator.push(
              ...
              MaterialPageRoute(
                builder: (_) => ChatScreen(
                  ...
                  themUserName: chat.themUserName,
              ...
              children: [
                ...
                Stack(
                  children: [
                    Container(
                      width: 50, height: 50,
                      decoration: BoxDecoration(color: _avatarColor(chat.themUserName), shape: BoxShape.circle),
                      child: Center(
                        child: Text(_initials(chat.themUserName),
                            style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 16)),
                      ),
                    ),
                    if (chat.themIsOnline)
                      Positioned(
                        bottom: 1, right: 1,
                        child: Container(
                          width: 13, height: 13,
                          decoration: BoxDecoration(
                            ...
                            shape: BoxShape.circle,
                            border: Border.all(color: isDark ? AppTheme.darkCard : AppTheme.lightCard, width: 2),
                          ),
                        ),
                      ),
                  ],
                        ...
                        children: [
                          if (chat.isMediaMessage)
                            Padding(
                              ...
                              child: Icon(_mediaIcon(chat.fileType), size: 14,
                                  color: isDark
                                      ? AppTheme.darkTextSecondary.withOpacity(0.6)
                                      : AppTheme.lightTextSecondary.withOpacity(0.6)),
                            ),
                          Expanded(
                            child: Text(chat.previewText,
                                style: TextStyle(
                                  color: chat.unRead > 0
                                      ? (isDark
                  ...
                  children: [
                    ...
                    if (chat.unRead > 0)
                      Container(
                        ...
                        decoration: const BoxDecoration(color: AppTheme.redAccent, shape: BoxShape.circle),
                        child: Center(
                          child: Text(chat.unRead > 99 ? '99+' : '${chat.unRead}',
  ...
  void _showLogoutDialog(bool isDark) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text('Logout',
            style: TextStyle(color: isDark ? AppTheme.darkTextPrimary : AppTheme.lightTextPrimary, fontWeight: FontWeight.w700)),
        ...
        actions: [
          ...
          TextButton(
            ...
            child: const Text('Logout', style: TextStyle(color: AppTheme.redAccent, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
    );
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Container(
                width: 44, height: 44,
                decoration: BoxDecoration(color: _avatarColor(user.label), shape: BoxShape.circle),
                child: Center(
